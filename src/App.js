...
function App() {
  ...
  return (
    <div className="container">
      <div className="row">
        <div className="col-6 m-auto my-5 border border-black rounded py-4 bg-black">
          <form action="" >
            ...
            <button type='button' className='btn btn-sm btn btn-outline-primary' onClick={handleOnClickUppercase}>Convert To Uppercase</button>
            <button type='button' className='btn btn-sm btn btn-outline-primary mx-3' onClick={handleOnClickLowercase}>Convert To Lowercase</button>
          </form>
